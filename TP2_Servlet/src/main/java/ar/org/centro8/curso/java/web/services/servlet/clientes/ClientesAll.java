package ar.org.centro8.curso.java.web.services.servlet.clientes;
...
public class ClientesAll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            //Gson gson=new Gson();
            //out.println(gson.toJson(cr.getAll()));
            out.println(new Gson().toJson(cr.getAll()));
        }
    }
