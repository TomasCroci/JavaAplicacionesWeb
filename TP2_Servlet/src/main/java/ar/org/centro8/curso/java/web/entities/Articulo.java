...
public Articulo() {   
 ...
 public Articulo(String nombre, String descripcion, TipoArticulo tipoArticulo, EspecieRecomendada especieRecomendada, double costo, double precio, int stock, int stockMinimo, int stockMaximo, String comentario, boolean activo) {
        this.nombre = nombre;
 ...
 public Articulo(int id, String nombre, String descripcion, TipoArticulo tipoArticulo, EspecieRecomendada especieRecomendada, double costo, double precio, int stock, int stockMinimo, int stockMaximo, String comentario, boolean activo) {
    ...
    public String toString() {
        return "Articulo{" + "id=" + id + ", nombre=" + nombre + ", descripcion=" + descripcion + ", tipoArticulo=" + tipoArticulo + ", especieRecomendada=" + especieRecomendada + ", costo=" + costo + ", precio=" + precio + ", stock=" + stock + ", stockMinimo=" + stockMinimo + ", stockMaximo=" + stockMaximo + ", comentarios=" + comentario + ", activo=" + activo + '}';
    }
